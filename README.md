# Q*bert -- TAC 485 Spring 2026 Final
...
Pick one of the following options to build and run the game:
...
## Credits
Thanks to Matthew Whiting for being an amazing teacher!

Some code generated by Claude.
